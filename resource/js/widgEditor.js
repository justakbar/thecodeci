...
function widgToolbar(theEditor)
{
	...
	for (var i = 0; i < widgToolbarItems.length; i++)
	{
		...
		{
			case "bold":
				this.addButton(this.theList.id + "ButtonBold", "btn btn-light", "<i class=\"fas fa-bold\"> </i>", "bold");
				
				break;
				
			case "italic":
				this.addButton(this.theList.id + "ButtonItalic", "btn btn-light", "<i class=\"fas fa-italic\"></i>", "italic");
				
				break;
				
			case "hyperlink":
				this.addButton(this.theList.id + "ButtonLink", "btn btn-light", "<i class=\"fas fa-link\"></i>", "link");
				
				break;
				
			case "unorderedlist":
				this.addButton(this.theList.id + "ButtonUnordered", "btn btn-light", "<i class=\"fas fa-list-ul\"></i>", "insertunorderedlist");
				
				break;
				
			case "orderedlist":
				this.addButton(this.theList.id + "ButtonOrdered", "btn btn-light", "<i class=\"fas fa-list-ol\"></i>", "insertorderedlist");
				
				break;
				
			case "image":
				this.addButton(this.theList.id + "ButtonImage", "btn btn-light", "<i class=\"fas fa-images\"></i>", "image");
			...
			case "blockformat":
				this.addSelect(this.theList.id + "SelectBlock", "custom-select custom-select-sm", widgSelectBlockOptions, "formatblock");
